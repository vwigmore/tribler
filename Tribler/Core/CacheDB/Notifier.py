...
from Tribler.Core.simpledefs import (NTFY_TORRENTS, NTFY_PLAYLISTS, NTFY_COMMENTS,
                                     ...
                                     NTFY_WATCH_CORRUPT_FOLDER, NTFY_NEW_VERSION, NTFY_TRIBLER, NTFY_UPGRADER_TICK)
...
class Notifier(object):
    ...
    SUBJECTS = [NTFY_TORRENTS, NTFY_PLAYLISTS, NTFY_COMMENTS, NTFY_MODIFICATIONS, NTFY_MODERATIONS, NTFY_MARKINGS,
                ...
                SIGNAL_SEARCH_COMMUNITY, SIGNAL_TORRENT, NTFY_WATCH_CORRUPT_FOLDER, NTFY_NEW_VERSION, NTFY_TRIBLER,
                NTFY_UPGRADER_TICK]
