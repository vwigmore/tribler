...
class PagerankReputationManager(ReputationManager):
    ...
    def compute(self, own_public_key):
        ...
        for block in self.blocks:
            ...
            G.add_edge(block.public_key, block.link_public_key, attr_dict={'weight': block.asset1_amount})
            G.add_edge(block.link_public_key, block.public_key, attr_dict={'weight': block.asset2_amount})
