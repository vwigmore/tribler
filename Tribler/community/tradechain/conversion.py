"""
All conversions for the TradeChain Community.
"""
from struct import pack, unpack_from, calcsize

from Tribler.community.tradechain.block import TradeChainBlock, block_pack_size, PK_LENGTH, EMPTY_PK
...
class TradeChainConversion(BinaryConversion):
    """
    Class that handles all encoding and decoding of TradeChain messages.
    """
    def __init__(self, community):
        super(TradeChainConversion, self).__init__(community, "\x01")
        from Tribler.community.tradechain.community import HALF_BLOCK, CRAWL
    ...
    def _decode_half_block(placeholder, offset, data):
        ...
        return offset + block_pack_size, placeholder.meta.payload.implement(
            TradeChainBlock.unpack(data, offset))
